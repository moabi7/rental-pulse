  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col md:flex-row justify-around">
        ...
        >
          ...
          <div className="text-2xl font-bold text-blue-500">
            {property.rates.weekly? (`R${property.rates.weekly.toLocaleString()}`) : (
                <FaTimes className='text-red-700'/>
            )}
          </div>
        ...
        <div className="flex items-center justify-center mb-4 pb-4 md:pb-0">
          ...
          <div className="text-2xl font-bold text-blue-500">
            {property.rates.monthly? (`R${property.rates.monthly.toLocaleString()}`) : (
                <FaTimes className='text-red-700'/>
            )}
          </div>
        </div>
    ...
    <div className="bg-white p-6 rounded-lg shadow-md mt-6">
      ...
      >
        ...
        <p>
          <FaRulerCombined className='inline-block mr-3'/>  {property?.square_meters}{' '}
            <span className="hidden sm:inline">sqm</span>
        </p>
      </div>
